queue()
  .defer(d3.json, "state_1890.json")
  .defer(d3.csv,  "judges_1800s.csv")
  .await(ready);
...
var current = { "year": 1890, "map" : maps.slavePopulation };
...
var brushToYear = d3.scale.threshold()
      .domain([1850, 1860, 1870, 1880, 1890])
      .range([1850, 1860, 1870, 1880, 1890]);
...
function ready(error, state_1890, judges_1800s) { 
